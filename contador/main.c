...
{
    FILE *archivo;
    char nombreArchivo[] = "C:\\Users\\munoz\\Downloads\\eBook - 23 H�bitos Anti-Procrastinaci�n C�mo dejar de ser perezoso y tener resultados en tu vida. By S.J. Scott.txt";
    char caracter;
