...
void main(void)
{ int CLA, CAT, ANT, RES; printf("\nIngrese la clave, categoria y antiguedad del trabajador:"); scanf("%d %d %d", &CLA, &CAT, &ANT); switch(CAT)
{ case 3:
case 4: if (ANT >= 5)
RES = 1;
else
...
printf("\nEl trabajador con clave %d reúne las condiciones para el puesto", CLA);
    ...
    printf("\nEl trabajador con clave %d no reúne las condiciones para el puesto2", CLA);
