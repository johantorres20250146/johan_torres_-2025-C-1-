...
for (I=0; I<T; I++) printf("\nVEC[%d]: %d", I, VEC[I]);
 ...
 Frecuencia(int A[], int P, int B[], int T)
/* Esta función calcula la frecuencia de calificaciones. */
{ int I;
for (I=0; I<P; I++) if ((A[I] >= 0) && (A[I] < 6))     /* Se valida que la calificación sea correcta. */
...
{
int I, MFRE = 0, MVAL = X[0]; for (I=1; I<T; I++) if (MVAL < X[I])
{
MFRE = I;
MVAL = X[I];
