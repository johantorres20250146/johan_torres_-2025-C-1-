...
/* Se declaran tres arreglos de tipo entero de 10 elementos. */ Lectura(VE1, MAX);
/* Se llama a la funcion Lectura. Observa que el paso del arreglo a la función es por referencia. Sólo se debe incluir el nombre del arreglo. */ Lectura(VE2, MAX);
